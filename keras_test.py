...
def load_images(num_images_to_load, first_image_index, step):
        ...
        for j in range(0, num_images_to_load, step):
                ...
                frames_directory = '/home/alex/Documents/worm_centerline/2000_frames/'
...
#print np.shape(x_train[25].reshape(1, 300, 300, 1))
...
#x_train /= 255 #already done
#x_test /= 255 #already done
